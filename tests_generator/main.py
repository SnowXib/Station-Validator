...
from tests_generator.validator import (
    validate_json_schema,
    get_script_test_schema,
    get_simple_test_schema,
)
...
def generator(db, station, count_of_tests):
    ...
    simple_tests = [
        next(simple_test_generator(objects))
        for _ in range(count_of_tests - count_of_script_tests)
    ]
    ...
    scipt_tests = [
        next(script_test_generator(objects)) for _ in range(count_of_script_tests)
    ]
