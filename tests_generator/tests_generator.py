...
def simple_test_generator(objects: list, test_run_id: str) -> Generator[dict[str, Any], None, None]:
    """
    ...
    while True:
        value_for_setup = random.choice(obj_for_test["variables"][variable_for_test])
        if value_for_setup['value'] != 'UNDEF' and value_for_setup['value'] != value_for_test['value']:
...
def script_test_generator(objects: list, test_run_id: id) -> Generator[dict[str, Any], None, None]:
    """
